...
export class GithubReporter {
  report(result: FlakinessReport): string {
    ...
    lines.push(
      `| Flakiness Rate | ${rateEmoji} ${(result.overallFlakinessRate * 100).toFixed(1)}% |`,
    );
    lines.push('');
    ...
    lines.push('---');
    lines.push(
      '*Generated by [flaky-test-detective](https://github.com/mustafaautomation/flaky-test-detective)*',
    );
